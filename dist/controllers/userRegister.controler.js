...
const userRegister = async (req, res) => {
    ...
    try {
        ...
        await database_1.Connection.query('INSERT INTO users (nome, email, senha, verificado, codigo_verificacao) VALUES (?, ?, ?, ?, ?)', [novoUsuario.nome, novoUsuario.email, novoUsuario.senha, novoUsuario.verificado, novoUsuario.codigo_verificacao]);
